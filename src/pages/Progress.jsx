  ...
  const progressData = [
    {
      ...
      achievements: [
        'Letter A-M mastered',
        'Counting to 10',
        'Favorite Bible verse learned',
        'Colors identification complete'
      ],
    ...
    },
    {
      ...
      course: 'Toddler Program',
      progress: 70,
      achievements: [
        'Basic shapes recognition',
        'Simple words pronunciation',
        ...
        {skillNames.map((skill) => (
          <div key={skill} className="flex items-center space-x-3">
            ...
            <div className="flex-1 bg-gray-200 rounded-full h-2">
              <motion.div
                className={`h-2 rounded-full ${getProgressColor(skills[skill])}`}
                initial={{ width: 0 }}
                whileInView={{ width: `${skills[skill]}%` }}
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <motion.div
                      className={`h-3 rounded-full ${getProgressColor(progress.progress)}`}
                      initial={{ width: 0 }}
            ...
            {[
              {
                ...
                description: 'Encourage daily reading sessions to improve literacy skills and vocabulary development.'
              },
              {
                icon: FiTarget,
                title: 'Set Goals Together',
                description: 'Work with your child to set achievable learning goals and celebrate milestones.'
              },
              {
                icon: FiCalendar,
                title: 'Consistent Routine',
                description: 'Maintain a regular study schedule to reinforce learning and build good habits.'
              },
              {
                icon: FiUser,
                title: 'Teacher Communication',
                description: 'Stay in regular contact with teachers to understand your child\'s progress and needs.'
              },
              {
                icon: FiAward,
                title: 'Celebrate Achievements',
                description: 'Acknowledge and celebrate your child\'s accomplishments to boost confidence.'
              },
              {
                icon: FiTrendingUp,
                title: 'Monitor Progress',
                description: 'Regularly review progress reports and discuss improvements with your child.'
              }
            ].map((tip, index) => (
              <motion.div
                key={index}
