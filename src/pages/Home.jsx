...
<img src="https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1752200684892-Screenshot%202025-07-10%20131640.png" alt="Happy children learning with colorful blocks" className="rounded-2xl shadow-clean-xl w-full h-96 object-cover" onError={(e)=> {console.error('Hero image failed to load');e.target.src='https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=600&h=400&fit=crop';}} /> 
...
<img src={course.image} alt={course.title} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" onError={(e)=> {console.error('Course image failed to load:',course.image);e.target.src='https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=600&h=400&fit=crop';}} /> 
</div> 
<div className="p-6"> 
...
<img src={image.src} alt={image.title} className="w-full h-full object-cover" onError={(e)=> {console.error('Gallery image failed to load:',image.src);e.target.src='https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=400&h=300&fit=crop';}} /> 
</div> 
...
<img src="https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1752200970714-blob" alt="Parents and teachers discussing child's progress" className="rounded-2xl shadow-xl w-full h-96 object-cover" onError={(e)=> {console.error('Testimonial image failed to load');e.target.src='https://images.unsplash.com/photo-1587095951604-b9d924a3fda0?w=600&h=500&fit=crop';}} /> 
...
<img src={testimonial.image} alt={testimonial.name} className="w-14 h-14 rounded-xl object-cover shadow-clean" onError={(e)=> {console.error('Testimonial image failed to load:',testimonial.image);e.target.style.display='none';}} /> 
<div className="ml-4"> 
