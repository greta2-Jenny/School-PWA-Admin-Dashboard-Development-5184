...
const Home=()=> {
  ...
  const testimonials=[ 
    {name: 'Sarah Johnson',role: 'Parent',content: 'My daughter Emma loves going to school every day. The teachers are so caring and the Christian values they teach are wonderful.',image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face'},
    {name: 'Michael Chen',role: 'Parent',content: 'The small class sizes and individual attention have helped my son develop confidence and social skills. Highly recommend!',image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face'},
    {name: 'Lisa Rodriguez',role: 'Parent',content: 'Lil\' Hale Learners has been a blessing to our family. The curriculum is excellent and the environment is so nurturing.',image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face'} 
  ];
  ...
  return ( 
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900' : 'bg-white'}`}> 
      ...
      <section className={`section-spacing-lg ${darkMode ? 'bg-gray-800' : 'solid-bg-warm-blush'}`}> 
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10"> 
          <div className="grid lg:grid-cols-2 gap-20 items-center"> 
            <motion.div initial={{opacity: 0,x: -50}} animate={{opacity: 1,x: 0}} transition={{duration: 0.8}} className={`${darkMode ? 'text-white' : 'text-muted-purple'}`} > 
              <motion.h1 className="font-display font-bold text-5xl lg:text-6xl mb-10" initial={{opacity: 0,y: 20}} animate={{opacity: 1,y: 0}} transition={{delay: 0.2}} > 
                Nurturing Young Minds Through Faith 
              </motion.h1> 
              <motion.p className={`text-xl lg:text-2xl mb-12 font-body font-medium leading-relaxed ${darkMode ? 'text-gray-300' : 'text-muted-purple'}`} initial={{opacity: 0,y: 20}} animate={{opacity: 1,y: 0}} transition={{delay: 0.4}} > 
                {settings.tagline} 
              </motion.p> 
              <motion.div className="flex flex-col sm:flex-row gap-6" initial={{opacity: 0,y: 20}} animate={{opacity: 1,y: 0}} transition={{delay: 0.6}} > 
                <Link to="/enrollment" className="inline-flex items-center px-8 py-4 bg-dusty-blue text-white font-display font-bold text-lg rounded-xl hover:bg-dusty-blue-light hover:scale-105 transition-all duration-300 shadow-clean" > 
                  Enroll Now <SafeIcon icon={FiArrowRight} className="ml-3 w-5 h-5" /> 
                </Link> 
                <Link to="/contact" className="inline-flex items-center px-8 py-4 bg-soft-rose text-white font-display font-bold text-lg rounded-xl hover:bg-soft-rose-light hover:scale-105 transition-all duration-300 shadow-clean" > 
                  Book a Tour <SafeIcon icon={FiCalendar} className="ml-3 w-5 h-5" /> 
                </Link> 
              </motion.div> 
            </motion.div> 
            <motion.div initial={{opacity: 0,x: 50}} animate={{opacity: 1,x: 0}} transition={{duration: 0.8,delay: 0.2}} className="relative" > 
              <div className="relative z-10"> 
                <img src="https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1752124617569-Screenshot%202025-07-10%20131640.png" alt="Happy children learning" className="rounded-2xl shadow-clean-xl w-full h-96 object-cover" /> 
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10"> 
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8"> 
            {stats.map((stat,index)=> ( 
              <motion.div key={index} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: index * 0.1}} className="stats-card" > 
      ...
      <section className={`section-spacing-lg ${darkMode ? 'bg-gray-700' : 'solid-bg-dusty-blue'}`}> 
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10"> 
          <div className="text-center mb-16"> 
            <motion.h2 className="font-display font-bold text-4xl lg:text-5xl mb-6 text-white" initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} > 
              Our Programs 
            </motion.h2> 
            <motion.p className="text-xl font-body font-medium text-white max-w-4xl mx-auto leading-relaxed" initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: 0.2}} > 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8"> 
            {data.courses.slice(0,6).map((course,index)=> ( 
              <motion.div key={course.id} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: index * 0.1}} className="bg-white rounded-2xl overflow-hidden shadow-clean hover:shadow-clean-lg transition-all duration-300 hover:scale-105" > 
                ...
                <div className="p-6"> 
                  ...
                  <div className="flex items-center justify-between"> 
                    ...
                    <Link to="/programs" className="text-dusty-blue hover:text-soft-rose font-display font-bold text-sm flex items-center transition-colors duration-200" > 
                      Learn More <SafeIcon icon={FiArrowRight} className="w-4 h-4 ml-1" /> 
                    </Link> 
                  </div> 
                </div> 
              </motion.div> 
          ...
          <div className="text-center mt-12"> 
            <Link to="/programs" className="inline-flex items-center px-8 py-4 bg-white text-dusty-blue font-display font-bold text-lg rounded-xl hover:bg-gray-100 hover:scale-105 transition-all duration-300 shadow-clean" > 
              View All Programs <SafeIcon icon={FiArrowRight} className="ml-3 w-5 h-5" /> 
            </Link> 
          </div> 
        </div> 
      </section> 
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10"> 
          ...
          <div className="grid md:grid-cols-2 gap-8"> 
            {specialFeatures.map((feature,index)=> ( 
              <motion.div key={index} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: index * 0.1}} className="bg-white rounded-2xl p-6 shadow-clean hover:shadow-clean-lg transition-all duration-300 hover:scale-105" > 
      ...
      <section className={`section-spacing-lg ${darkMode ? 'bg-gray-900' : 'solid-bg-white'}`}> 
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10"> 
          <div className="text-center mb-16"> 
            <motion.h2 className={`font-display font-bold text-4xl lg:text-5xl mb-6 ${darkMode ? 'text-white' : 'text-muted-purple'}`} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} > 
              Life at Our School 
            </motion.h2> 
            <motion.p className={`text-xl font-body font-medium ${darkMode ? 'text-gray-300' : 'text-gray-600'} max-w-4xl mx-auto leading-relaxed`} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: 0.2}} > 
              Glimpses of joy,learning,and growth at Lil' Hale Learners 
            </motion.p> 
          </div> 
          <div className="gallery-grid"> 
            {galleryImages.map((image,index)=> ( 
              <motion.div key={index} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: index * 0.1}} className="gallery-item border-2 border-soft-rose" > 
          ...
          <div className="text-center mt-12"> 
            <Link to="/gallery" className="inline-flex items-center px-8 py-4 bg-soft-rose text-white font-display font-bold text-lg rounded-xl hover:bg-soft-rose-light hover:scale-105 transition-all duration-300 shadow-clean" > 
              View More Photos <SafeIcon icon={FiArrowRight} className="ml-3 w-5 h-5" /> 
            </Link> 
          </div> 
        </div> 
      </section> 
      ...
      <section className={`section-spacing-lg ${darkMode ? 'bg-gray-800' : 'solid-bg-warm-blush'}`}> 
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10"> 
          <div className="text-center mb-16"> 
            ...
            <motion.p className={`text-xl font-body font-medium ${darkMode ? 'text-gray-300' : 'text-muted-purple'} max-w-4xl mx-auto leading-relaxed`} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: 0.2}} > 
            ...
            {testimonials.map((testimonial,index)=> ( 
              <motion.div key={index} initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: index * 0.1}} className="bg-white rounded-2xl p-6 shadow-clean hover:shadow-clean-lg transition-all duration-300 hover:scale-105" > 
                <div className="flex items-center mb-6"> 
                  <img src={testimonial.image} alt={testimonial.name} className="w-14 h-14 rounded-xl object-cover shadow-clean" /> 
                  <div className="ml-4"> 
          ...
          <div className="text-center mt-12"> 
            <motion.div className="flex flex-col sm:flex-row gap-6 justify-center" initial={{opacity: 0,y: 20}} whileInView={{opacity: 1,y: 0}} transition={{delay: 0.4}} > 
              <Link to="/enrollment" className="inline-flex items-center px-8 py-4 bg-dusty-blue text-white font-display font-bold text-lg rounded-xl hover:bg-dusty-blue-light hover:scale-105 transition-all duration-300 shadow-clean" > 
                Enroll Now <SafeIcon icon={FiArrowRight} className="ml-3 w-5 h-5" /> 
              </Link> 
              <Link to="/contact" className="inline-flex items-center px-8 py-4 bg-muted-purple text-white font-display font-bold text-lg rounded-xl hover:bg-muted-purple-light hover:scale-105 transition-all duration-300 shadow-clean" > 
                Contact Us <SafeIcon icon={FiMessageCircle} className="ml-3 w-5 h-5" /> 
              </Link> 
            </motion.div> 
          </div> 
        </div> 
